...
main(int argc, char **argv)
{
  ...
  50:	85458593          	add	a1,a1,-1964 # 8a0 <lock_release+0x1e>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	54250513          	add	a0,a0,1346 # 918 <digits>
 3de:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e0:	3e470713          	add	a4,a4,996 # 8c0 <lock_release+0x3e>
 ...
 56c:	3b0b8b93          	add	s7,s7,944 # 918 <digits>
 ...
 5c2:	2fa90913          	add	s2,s2,762 # 8b8 <lock_release+0x36>
        while(*s != 0){
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 82c:	eee080e7          	jalr	-274(ra) # 716 <malloc>
    int tid = clone(st_ptr);
 830:	00000097          	auipc	ra,0x0
 834:	b5e080e7          	jalr	-1186(ra) # 38e <clone>
 ...
 852:	aa0080e7          	jalr	-1376(ra) # 2ee <exit>
...
void lock_acquire(struct lock_t* lock) {
 866:	1141                	add	sp,sp,-16
 868:	e422                	sd	s0,8(sp)
 86a:	0800                	add	s0,sp,16
