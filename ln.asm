...
main(int argc, char *argv[])
{
  ...
  14:	89058593          	add	a1,a1,-1904 # 8a0 <lock_release+0x24>
  18:	4509                	li	a0,2
  ...
  52:	86a58593          	add	a1,a1,-1942 # 8b8 <lock_release+0x3c>
  56:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	56050513          	add	a0,a0,1376 # 930 <digits>
 3d8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4da:	40270713          	add	a4,a4,1026 # 8d8 <lock_release+0x5c>
 ...
 566:	3ceb8b93          	add	s7,s7,974 # 930 <digits>
 ...
 5bc:	31890913          	add	s2,s2,792 # 8d0 <lock_release+0x54>
        while(*s != 0){
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 826:	eee080e7          	jalr	-274(ra) # 710 <malloc>
    int tid = clone(st_ptr);
 82a:	00000097          	auipc	ra,0x0
 82e:	b5e080e7          	jalr	-1186(ra) # 388 <clone>
 ...
 84c:	aa0080e7          	jalr	-1376(ra) # 2e8 <exit>

0000000000000850 <lock_init>:

// Initialize a lock.
void lock_init(struct lock_t* lock) {
 850:	1141                	add	sp,sp,-16
 852:	e422                	sd	s0,8(sp)
 854:	0800                	add	s0,sp,16
    lock->locked = 0;
 856:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 85a:	6422                	ld	s0,8(sp)
 85c:	0141                	add	sp,sp,16
 85e:	8082                	ret
