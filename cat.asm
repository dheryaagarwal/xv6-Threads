...
cat(int fd)
{
  ...
  44:	92058593          	add	a1,a1,-1760 # 960 <lock_release+0x24>
  48:	4509                	li	a0,2
  ...
  72:	90a58593          	add	a1,a1,-1782 # 978 <lock_release+0x3c>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 10a:	88a58593          	add	a1,a1,-1910 # 990 <lock_release+0x54>
 10e:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 494:	57850513          	add	a0,a0,1400 # a08 <digits>
 498:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 59a:	41a70713          	add	a4,a4,1050 # 9b0 <lock_release+0x74>
 ...
 626:	3e6b8b93          	add	s7,s7,998 # a08 <digits>
 ...
 67c:	33090913          	add	s2,s2,816 # 9a8 <lock_release+0x6c>
        while(*s != 0){
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 8e6:	eee080e7          	jalr	-274(ra) # 7d0 <malloc>
    int tid = clone(st_ptr);
 8ea:	00000097          	auipc	ra,0x0
 8ee:	b5e080e7          	jalr	-1186(ra) # 448 <clone>
 ...
 90c:	aa0080e7          	jalr	-1376(ra) # 3a8 <exit>
...
void lock_release(struct lock_t* lock) {
 93c:	1141                	add	sp,sp,-16
 93e:	e422                	sd	s0,8(sp)
 940:	0800                	add	s0,sp,16
