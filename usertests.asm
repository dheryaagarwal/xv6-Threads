...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	17250513          	add	a0,a0,370 # 61b0 <lock_release+0x20>
      ...
      74:	8082                	ret
{
      ...
      84:	15050513          	add	a0,a0,336 # 61d0 <lock_release+0x40>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	14050513          	add	a0,a0,320 # 61e8 <lock_release+0x58>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	14250513          	add	a0,a0,322 # 6208 <lock_release+0x78>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	10a50513          	add	a0,a0,266 # 61f0 <lock_release+0x60>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	11650513          	add	a0,a0,278 # 6218 <lock_release+0x88>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	11450513          	add	a0,a0,276 # 6240 <lock_release+0xb0>
     134:	00006097          	auipc	ra,0x6
     138:	b18080e7          	jalr	-1256(ra) # 5c4c <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	10050513          	add	a0,a0,256 # 6240 <lock_release+0xb0>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	0fc58593          	add	a1,a1,252 # 6250 <lock_release+0xc0>
     15c:	00006097          	auipc	ra,0x6
     160:	ac0080e7          	jalr	-1344(ra) # 5c1c <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	0d850513          	add	a0,a0,216 # 6240 <lock_release+0xb0>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	0dc58593          	add	a1,a1,220 # 6258 <lock_release+0xc8>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	0ac50513          	add	a0,a0,172 # 6240 <lock_release+0xb0>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	09650513          	add	a0,a0,150 # 6260 <lock_release+0xd0>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	00c50513          	add	a0,a0,12 # 6288 <lock_release+0xf8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	ff8a8a93          	add	s5,s5,-8 # 6288 <lock_release+0xf8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f8650513          	add	a0,a0,-122 # 6298 <lock_release+0x108>
     ...
     338:	f8450513          	add	a0,a0,-124 # 62b8 <lock_release+0x128>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	f7250513          	add	a0,a0,-142 # 62d0 <lock_release+0x140>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	f5e98993          	add	s3,s3,-162 # 62d0 <lock_release+0x140>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	f1250513          	add	a0,a0,-238 # 62d0 <lock_release+0x140>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	e8258593          	add	a1,a1,-382 # 6258 <lock_release+0xc8>
    ...
    printf("write failed\n");
     ...
     3f0:	f0450513          	add	a0,a0,-252 # 62f0 <lock_release+0x160>
    ...
    exit(1);
     ...
     40a:	ed250513          	add	a0,a0,-302 # 62d8 <lock_release+0x148>
    ...
    printf("open junk failed\n");
     ...
     424:	eb850513          	add	a0,a0,-328 # 62d8 <lock_release+0x148>
  ...
  unlink("junk");
     ...
     448:	e8c50513          	add	a0,a0,-372 # 62d0 <lock_release+0x140>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	db0a0a13          	add	s4,s4,-592 # 6300 <lock_release+0x170>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	d0c50513          	add	a0,a0,-756 # 6308 <lock_release+0x178>
     ...
     61e:	d0650513          	add	a0,a0,-762 # 6320 <lock_release+0x190>
     ...
     63c:	d1850513          	add	a0,a0,-744 # 6350 <lock_release+0x1c0>
     ...
     656:	d2e50513          	add	a0,a0,-722 # 6380 <lock_release+0x1f0>
     ...
     674:	d2050513          	add	a0,a0,-736 # 6390 <lock_release+0x200>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	d12a0a13          	add	s4,s4,-750 # 63c0 <lock_release+0x230>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	ba2a8a93          	add	s5,s5,-1118 # 6258 <lock_release+0xc8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	c6c50513          	add	a0,a0,-916 # 63c8 <lock_release+0x238>
     ...
     77e:	c6650513          	add	a0,a0,-922 # 63e0 <lock_release+0x250>
     ...
     798:	bec50513          	add	a0,a0,-1044 # 6380 <lock_release+0x1f0>
     ...
     7b2:	c6250513          	add	a0,a0,-926 # 6410 <lock_release+0x280>
     ...
     7d0:	c5c50513          	add	a0,a0,-932 # 6428 <lock_release+0x298>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	a2e58593          	add	a1,a1,-1490 # 6250 <lock_release+0xc0>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	a0250513          	add	a0,a0,-1534 # 6240 <lock_release+0xb0>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	9d650513          	add	a0,a0,-1578 # 6240 <lock_release+0xb0>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	9c250513          	add	a0,a0,-1598 # 6240 <lock_release+0xb0>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	bfc58593          	add	a1,a1,-1028 # 64b8 <lock_release+0x328>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	94250513          	add	a0,a0,-1726 # 6240 <lock_release+0xb0>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	b1650513          	add	a0,a0,-1258 # 6458 <lock_release+0x2c8>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	b1a50513          	add	a0,a0,-1254 # 6478 <lock_release+0x2e8>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	b1650513          	add	a0,a0,-1258 # 6488 <lock_release+0x2f8>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	b1a50513          	add	a0,a0,-1254 # 64a8 <lock_release+0x318>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	ae650513          	add	a0,a0,-1306 # 6488 <lock_release+0x2f8>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	b0050513          	add	a0,a0,-1280 # 64c0 <lock_release+0x330>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	b0250513          	add	a0,a0,-1278 # 64e0 <lock_release+0x350>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	aee50513          	add	a0,a0,-1298 # 6500 <lock_release+0x370>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	afe98993          	add	s3,s3,-1282 # 6528 <lock_release+0x398>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	b2ea8a93          	add	s5,s5,-1234 # 6560 <lock_release+0x3d0>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	a8850513          	add	a0,a0,-1400 # 6500 <lock_release+0x370>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	a4c50513          	add	a0,a0,-1460 # 6500 <lock_release+0x370>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	a2a50513          	add	a0,a0,-1494 # 6508 <lock_release+0x378>
    ...
    exit(1);
     ...
     b00:	a3c50513          	add	a0,a0,-1476 # 6538 <lock_release+0x3a8>
     ...
     b1e:	a5650513          	add	a0,a0,-1450 # 6570 <lock_release+0x3e0>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	a6250513          	add	a0,a0,-1438 # 6598 <lock_release+0x408>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	a6650513          	add	a0,a0,-1434 # 65b8 <lock_release+0x428>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	a6250513          	add	a0,a0,-1438 # 65d0 <lock_release+0x440>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	a5050513          	add	a0,a0,-1456 # 65f0 <lock_release+0x460>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	9fe50513          	add	a0,a0,-1538 # 65f0 <lock_release+0x460>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	9be50513          	add	a0,a0,-1602 # 65f8 <lock_release+0x468>
    ...
    exit(1);
     ...
     c5c:	9c050513          	add	a0,a0,-1600 # 6618 <lock_release+0x488>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	9cc50513          	add	a0,a0,-1588 # 6640 <lock_release+0x4b0>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	95050513          	add	a0,a0,-1712 # 65f0 <lock_release+0x460>
     ...
     cd0:	99450513          	add	a0,a0,-1644 # 6660 <lock_release+0x4d0>
     ...
     cee:	99e50513          	add	a0,a0,-1634 # 6688 <lock_release+0x4f8>
     ...
     d0c:	99850513          	add	a0,a0,-1640 # 66a0 <lock_release+0x510>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	9a450513          	add	a0,a0,-1628 # 66c8 <lock_release+0x538>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	98e50513          	add	a0,a0,-1650 # 66e0 <lock_release+0x550>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	9a658593          	add	a1,a1,-1626 # 6710 <lock_release+0x580>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	95a50513          	add	a0,a0,-1702 # 66e0 <lock_release+0x550>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	94450513          	add	a0,a0,-1724 # 66e0 <lock_release+0x550>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	92e50513          	add	a0,a0,-1746 # 66e0 <lock_release+0x550>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	99258593          	add	a1,a1,-1646 # 6758 <lock_release+0x5c8>
  ...
  unlink("unlinkread");
     ...
     e32:	8b250513          	add	a0,a0,-1870 # 66e0 <lock_release+0x550>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	8a250513          	add	a0,a0,-1886 # 66f0 <lock_release+0x560>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	8ae50513          	add	a0,a0,-1874 # 6718 <lock_release+0x588>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	8b250513          	add	a0,a0,-1870 # 6738 <lock_release+0x5a8>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	8be50513          	add	a0,a0,-1858 # 6760 <lock_release+0x5d0>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	8c250513          	add	a0,a0,-1854 # 6780 <lock_release+0x5f0>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	8c650513          	add	a0,a0,-1850 # 67a0 <lock_release+0x610>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	7d258593          	add	a1,a1,2002 # 6710 <lock_release+0x580>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	86a58593          	add	a1,a1,-1942 # 67c8 <lock_release+0x638>
     f66:	00006517          	auipc	a0,0x6
     f6a:	85a50513          	add	a0,a0,-1958 # 67c0 <lock_release+0x630>
  ...
  unlink("lf1");
     ...
     f7e:	84650513          	add	a0,a0,-1978 # 67c0 <lock_release+0x630>
     f82:	00005097          	auipc	ra,0x5
     f86:	cca080e7          	jalr	-822(ra) # 5c4c <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00006517          	auipc	a0,0x6
     f90:	83450513          	add	a0,a0,-1996 # 67c0 <lock_release+0x630>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	82650513          	add	a0,a0,-2010 # 67c8 <lock_release+0x638>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	7ee58593          	add	a1,a1,2030 # 67c8 <lock_release+0x638>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	7d850513          	add	a0,a0,2008 # 67c8 <lock_release+0x638>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c54080e7          	jalr	-940(ra) # 5c4c <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	7c058593          	add	a1,a1,1984 # 67c0 <lock_release+0x630>
    1008:	00005517          	auipc	a0,0x5
    100c:	7c050513          	add	a0,a0,1984 # 67c8 <lock_release+0x638>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	7a458593          	add	a1,a1,1956 # 67c0 <lock_release+0x630>
    1024:	00006517          	auipc	a0,0x6
    1028:	8ac50513          	add	a0,a0,-1876 # 68d0 <lock_release+0x740>
    ...
    104a:	78a50513          	add	a0,a0,1930 # 67d0 <lock_release+0x640>
    ...
    1066:	78650513          	add	a0,a0,1926 # 67e8 <lock_release+0x658>
    ...
    1082:	78250513          	add	a0,a0,1922 # 6800 <lock_release+0x670>
    ...
    109e:	78650513          	add	a0,a0,1926 # 6820 <lock_release+0x690>
    ...
    10ba:	79a50513          	add	a0,a0,1946 # 6850 <lock_release+0x6c0>
    ...
    10d6:	79650513          	add	a0,a0,1942 # 6868 <lock_release+0x6d8>
    ...
    10f2:	79250513          	add	a0,a0,1938 # 6880 <lock_release+0x6f0>
    ...
    110e:	79e50513          	add	a0,a0,1950 # 68a8 <lock_release+0x718>
    ...
    112a:	7b250513          	add	a0,a0,1970 # 68d8 <lock_release+0x748>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	7a098993          	add	s3,s3,1952 # 68f8 <lock_release+0x768>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	77450513          	add	a0,a0,1908 # 6908 <lock_release+0x778>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	72ea0a13          	add	s4,s4,1838 # 6928 <lock_release+0x798>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	6dc50513          	add	a0,a0,1756 # 6928 <lock_release+0x798>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	67450513          	add	a0,a0,1652 # 6930 <lock_release+0x7a0>
    ...
    12e0:	67450513          	add	a0,a0,1652 # 6950 <lock_release+0x7c0>
    ...
    12fc:	67850513          	add	a0,a0,1656 # 6970 <lock_release+0x7e0>
...
000000000000134a <badarg>:
{
    ...
    1368:	e8498993          	add	s3,s3,-380 # 61e8 <lock_release+0x58>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	7da78793          	add	a5,a5,2010 # 7bc8 <lock_release+0x1a38>
  ...
  if(pid == 0){
    ...
    144e:	1c678793          	add	a5,a5,454 # 8610 <lock_release+0x2480>
    ...
    1472:	d7a50513          	add	a0,a0,-646 # 61e8 <lock_release+0x58>
    ...
    148a:	59250513          	add	a0,a0,1426 # 6a18 <lock_release+0x888>
    ...
    14aa:	4ea50513          	add	a0,a0,1258 # 6990 <lock_release+0x800>
    ...
    14ca:	4ea50513          	add	a0,a0,1258 # 69b0 <lock_release+0x820>
    ...
    14ec:	4e850513          	add	a0,a0,1256 # 69d0 <lock_release+0x840>
    ...
    150c:	4f050513          	add	a0,a0,1264 # 69f8 <lock_release+0x868>
    ...
    1526:	95650513          	add	a0,a0,-1706 # 6e78 <lock_release+0xce8>
  ...
  if(st != 747){
    ...
    1570:	4d450513          	add	a0,a0,1236 # 6a40 <lock_release+0x8b0>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    159a:	caa50513          	add	a0,a0,-854 # 6240 <lock_release+0xb0>
  ...
  if(pid == 0){
    ...
    15cc:	c78a0a13          	add	s4,s4,-904 # 6240 <lock_release+0xb0>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	4d0a8a93          	add	s5,s5,1232 # 6aa0 <lock_release+0x910>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    164c:	42850513          	add	a0,a0,1064 # 6a70 <lock_release+0x8e0>
    ...
    1668:	42450513          	add	a0,a0,1060 # 6a88 <lock_release+0x8f8>
    ...
    1686:	42e50513          	add	a0,a0,1070 # 6ab0 <lock_release+0x920>
    ...
    16ac:	b98a0a13          	add	s4,s4,-1128 # 6240 <lock_release+0xb0>
    int n = write(fd, "xxx", 3);
    16b0:	00005a97          	auipc	s5,0x5
    16b4:	420a8a93          	add	s5,s5,1056 # 6ad0 <lock_release+0x940>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16fe:	b4650513          	add	a0,a0,-1210 # 6240 <lock_release+0xb0>
  ...
  exit(xstatus);
    ...
    171c:	37050513          	add	a0,a0,880 # 6a88 <lock_release+0x8f8>
    ...
    173a:	3a250513          	add	a0,a0,930 # 6ad8 <lock_release+0x948>
...
0000000000001750 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1760:	a8c78793          	add	a5,a5,-1396 # 61e8 <lock_release+0x58>
    1764:	fcf43023          	sd	a5,-64(s0)
    1768:	00005797          	auipc	a5,0x5
    176c:	39078793          	add	a5,a5,912 # 6af8 <lock_release+0x968>
    1770:	fcf43423          	sd	a5,-56(s0)
    1774:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1778:	00005517          	auipc	a0,0x5
    177c:	38850513          	add	a0,a0,904 # 6b00 <lock_release+0x970>
  ...
  if(pid == 0) {
    ...
    17ac:	35850513          	add	a0,a0,856 # 6b00 <lock_release+0x970>
    ...
    17c8:	35c50513          	add	a0,a0,860 # 6b20 <lock_release+0x990>
    ...
    17e6:	28e50513          	add	a0,a0,654 # 6a70 <lock_release+0x8e0>
    ...
    1802:	30a50513          	add	a0,a0,778 # 6b08 <lock_release+0x978>
    ...
    1820:	9cc50513          	add	a0,a0,-1588 # 61e8 <lock_release+0x58>
  ...
  if(xstatus != 0)
    ...
    1854:	2e050513          	add	a0,a0,736 # 6b30 <lock_release+0x9a0>
    ...
    1870:	2dc50513          	add	a0,a0,732 # 6b48 <lock_release+0x9b8>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1884:	28050513          	add	a0,a0,640 # 6b00 <lock_release+0x970>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18ae:	d0e50513          	add	a0,a0,-754 # 65b8 <lock_release+0x428>
    ...
    18ca:	1c250513          	add	a0,a0,450 # 6a88 <lock_release+0x8f8>
  ...
  unlink("echo-ok");
    ...
    18e4:	22050513          	add	a0,a0,544 # 6b00 <lock_release+0x970>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    190e:	25650513          	add	a0,a0,598 # 6b60 <lock_release+0x9d0>
...
000000000000192e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19d6:	1a650513          	add	a0,a0,422 # 6b78 <lock_release+0x9e8>
    ...
    1a18:	42da8a93          	add	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a64:	13050513          	add	a0,a0,304 # 6b90 <lock_release+0xa00>
    ...
    1a80:	12c50513          	add	a0,a0,300 # 6ba8 <lock_release+0xa18>
    ...
    1ab2:	11250513          	add	a0,a0,274 # 6bc0 <lock_release+0xa30>
    ...
    1afe:	0e650513          	add	a0,a0,230 # 6be0 <lock_release+0xa50>
...
0000000000001b14 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b70:	f0450513          	add	a0,a0,-252 # 6a70 <lock_release+0x8e0>
    ...
    1b8c:	07050513          	add	a0,a0,112 # 6bf8 <lock_release+0xa68>
    ...
    1ba8:	06c50513          	add	a0,a0,108 # 6c10 <lock_release+0xa80>
...
0000000000001bc8 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1c20:	e5450513          	add	a0,a0,-428 # 6a70 <lock_release+0x8e0>
    ...
    1c44:	e3050513          	add	a0,a0,-464 # 6a70 <lock_release+0x8e0>
...
0000000000001c62 <forkfork>:
{
    ...
    1cbe:	f7650513          	add	a0,a0,-138 # 6c30 <lock_release+0xaa0>
    ...
    1cd0:	f30080e7          	jalr	-208(ra) # 5bfc <exit>
{
    ...
    1d16:	f2e50513          	add	a0,a0,-210 # 6c40 <lock_release+0xab0>
...
0000000000001d2c <reparent2>:
{
  ...
  exit(0);
    ...
    1d64:	11850513          	add	a0,a0,280 # 6e78 <lock_release+0xce8>
...
0000000000001d94 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1e02:	07a50513          	add	a0,a0,122 # 6e78 <lock_release+0xce8>
    ...
    1e2e:	cde50513          	add	a0,a0,-802 # 6b08 <lock_release+0x978>
    ...
    1ea0:	dc450513          	add	a0,a0,-572 # 6c60 <lock_release+0xad0>
    ...
    1ed4:	da850513          	add	a0,a0,-600 # 6c78 <lock_release+0xae8>
    ...
    1f36:	d6e50513          	add	a0,a0,-658 # 6ca0 <lock_release+0xb10>
...
0000000000001fba <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fda:	28250513          	add	a0,a0,642 # 6258 <lock_release+0xc8>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2016:	246b0b13          	add	s6,s6,582 # 6258 <lock_release+0xc8>
      link("cat", "x");
    201a:	00005c17          	auipc	s8,0x5
    201e:	caec0c13          	add	s8,s8,-850 # 6cc8 <lock_release+0xb38>
    2022:	a825                	j	205a <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2024:	85a6                	mv	a1,s1
    2026:	00005517          	auipc	a0,0x5
    202a:	a4a50513          	add	a0,a0,-1462 # 6a70 <lock_release+0x8e0>
...
00000000000020be <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20ee:	c2e50513          	add	a0,a0,-978 # 6d18 <lock_release+0xb88>
    ...
    2112:	bc250513          	add	a0,a0,-1086 # 6cd0 <lock_release+0xb40>
    ...
    212e:	bbe50513          	add	a0,a0,-1090 # 6ce8 <lock_release+0xb58>
    ...
    214a:	bba50513          	add	a0,a0,-1094 # 6d00 <lock_release+0xb70>
...
0000000000002196 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2200:	87450513          	add	a0,a0,-1932 # 6a70 <lock_release+0x8e0>
    ...
    2222:	b2250513          	add	a0,a0,-1246 # 6d40 <lock_release+0xbb0>
...
0000000000002242 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22a4:	7d050513          	add	a0,a0,2000 # 6a70 <lock_release+0x8e0>
    ...
    22d0:	a9450513          	add	a0,a0,-1388 # 6d60 <lock_release+0xbd0>
...
00000000000022f0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2300:	a7c50513          	add	a0,a0,-1412 # 6d78 <lock_release+0xbe8>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2332:	a4a50513          	add	a0,a0,-1462 # 6d78 <lock_release+0xbe8>
  ...
  close(fd);
    ...
    2368:	a2470713          	add	a4,a4,-1500 # 6d88 <lock_release+0xbf8>
    ...
    23bc:	ab050513          	add	a0,a0,-1360 # 6e68 <lock_release+0xcd8>
    ...
    23e0:	aac50513          	add	a0,a0,-1364 # 6e88 <lock_release+0xcf8>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    243e:	a6e50513          	add	a0,a0,-1426 # 6ea8 <lock_release+0xd18>
    ...
    245a:	61a50513          	add	a0,a0,1562 # 6a70 <lock_release+0x8e0>
...
000000000000247a <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24c8:	5ac50513          	add	a0,a0,1452 # 6a70 <lock_release+0x8e0>
...
00000000000024e8 <manywrites>:
{
  ...
  exit(0);
    ...
    254c:	93050513          	add	a0,a0,-1744 # 6e78 <lock_release+0xce8>
    ...
    2602:	8d250513          	add	a0,a0,-1838 # 6ed0 <lock_release+0xd40>
    ...
    2622:	c9a50513          	add	a0,a0,-870 # 62b8 <lock_release+0x128>
...
0000000000002640 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    26ba:	51278793          	add	a5,a5,1298 # 7bc8 <lock_release+0x1a38>
  ...
  if(ret != -1){
    ...
    26fc:	7f050513          	add	a0,a0,2032 # 6ee8 <lock_release+0xd58>
    ...
    271a:	27a50513          	add	a0,a0,634 # 6990 <lock_release+0x800>
    ...
    2738:	27c50513          	add	a0,a0,636 # 69b0 <lock_release+0x820>
    ...
    2758:	27c50513          	add	a0,a0,636 # 69d0 <lock_release+0x840>
    ...
    2776:	28650513          	add	a0,a0,646 # 69f8 <lock_release+0x868>
...
000000000000278c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    27c2:	76a50513          	add	a0,a0,1898 # 6f28 <lock_release+0xd98>
  ...
  if(n >= 0){
    ...
    27f2:	75a50513          	add	a0,a0,1882 # 6f48 <lock_release+0xdb8>
    ...
    2810:	6e450513          	add	a0,a0,1764 # 6ef0 <lock_release+0xd60>
    ...
    282c:	6e050513          	add	a0,a0,1760 # 6f08 <lock_release+0xd78>
    ...
    2846:	6ee50513          	add	a0,a0,1774 # 6f30 <lock_release+0xda0>
  ...
  unlink("rwsbrk");
    ...
    286a:	6c250513          	add	a0,a0,1730 # 6f28 <lock_release+0xd98>
    286e:	00003097          	auipc	ra,0x3
    2872:	3de080e7          	jalr	990(ra) # 5c4c <unlink>
  fd = open("README", O_RDONLY);
    2876:	4581                	li	a1,0
    2878:	00004517          	auipc	a0,0x4
    287c:	b4850513          	add	a0,a0,-1208 # 63c0 <lock_release+0x230>
  ...
  if(n >= 0){
    ...
    28a6:	6d650513          	add	a0,a0,1750 # 6f78 <lock_release+0xde8>
    ...
    28c0:	67450513          	add	a0,a0,1652 # 6f30 <lock_release+0xda0>
...
00000000000028ea <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2946:	65e50513          	add	a0,a0,1630 # 6fa0 <lock_release+0xe10>
  ...
  for(i = 0; i < 5000; i++){
    ...
    29aa:	61a50513          	add	a0,a0,1562 # 6fc0 <lock_release+0xe30>
  ...
  if(c != a + 1){
    ...
    2a0e:	61650513          	add	a0,a0,1558 # 7020 <lock_release+0xe90>
    ...
    2a30:	5b450513          	add	a0,a0,1460 # 6fe0 <lock_release+0xe50>
    ...
    2a4c:	5b850513          	add	a0,a0,1464 # 7000 <lock_release+0xe70>
...
0000000000002a88 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b96:	4ae50513          	add	a0,a0,1198 # 7040 <lock_release+0xeb0>
    ...
    2bb2:	4da50513          	add	a0,a0,1242 # 7088 <lock_release+0xef8>
    ...
    2bd2:	4da50513          	add	a0,a0,1242 # 70a8 <lock_release+0xf18>
    ...
    2bf2:	4fa50513          	add	a0,a0,1274 # 70e8 <lock_release+0xf58>
    ...
    2c0e:	50e50513          	add	a0,a0,1294 # 7118 <lock_release+0xf88>
    ...
    2c2e:	52650513          	add	a0,a0,1318 # 7150 <lock_release+0xfc0>
...
0000000000002c44 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c68:	51450513          	add	a0,a0,1300 # 7178 <lock_release+0xfe8>
    2c6c:	00003097          	auipc	ra,0x3
    2c70:	fd0080e7          	jalr	-48(ra) # 5c3c <open>
    2c74:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c76:	00004517          	auipc	a0,0x4
    2c7a:	50250513          	add	a0,a0,1282 # 7178 <lock_release+0xfe8>
  ...
  if(pipe((int *) a) != 0){
    ...
    2cce:	4b650513          	add	a0,a0,1206 # 7180 <lock_release+0xff0>
    ...
    2cea:	4b250513          	add	a0,a0,1202 # 7198 <lock_release+0x1008>
    ...
    2d06:	e7650513          	add	a0,a0,-394 # 6b78 <lock_release+0x9e8>
...
0000000000002d1c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2d30:	48450513          	add	a0,a0,1156 # 71b0 <lock_release+0x1020>
  ...
  close(fd);
    ...
    2d78:	d1450513          	add	a0,a0,-748 # 6a88 <lock_release+0x8f8>
...
0000000000002d8e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2dc6:	0b650513          	add	a0,a0,182 # 6e78 <lock_release+0xce8>
  ...
  if(pid == 0){
    ...
    2e1c:	06050513          	add	a0,a0,96 # 6e78 <lock_release+0xce8>
...
0000000000002fae <execout>:
{
  ...
  exit(0);
    ...
    2ff0:	e8c50513          	add	a0,a0,-372 # 6e78 <lock_release+0xce8>
    ...
    3044:	1a850513          	add	a0,a0,424 # 61e8 <lock_release+0x58>
    3048:	faa43c23          	sd	a0,-72(s0)
    304c:	00003797          	auipc	a5,0x3
    3050:	20c78793          	add	a5,a5,524 # 6258 <lock_release+0xc8>
...
0000000000003072 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3082:	30a50513          	add	a0,a0,778 # 7388 <lock_release+0x11f8>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3094:	15050513          	add	a0,a0,336 # 71e0 <lock_release+0x1050>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    30aa:	19250513          	add	a0,a0,402 # 7238 <lock_release+0x10a8>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    30c8:	1ec50513          	add	a0,a0,492 # 72b0 <lock_release+0x1120>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    30e4:	24050513          	add	a0,a0,576 # 7320 <lock_release+0x1190>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30f6:	28650513          	add	a0,a0,646 # 7378 <lock_release+0x11e8>
  ...
  unlink("12345678901234");
    ...
    3174:	04850513          	add	a0,a0,72 # 71b8 <lock_release+0x1028>
    ...
    3190:	07450513          	add	a0,a0,116 # 7200 <lock_release+0x1070>
    ...
    31ac:	0c050513          	add	a0,a0,192 # 7268 <lock_release+0x10d8>
    ...
    31c8:	11c50513          	add	a0,a0,284 # 72e0 <lock_release+0x1150>
    ...
    31e4:	16050513          	add	a0,a0,352 # 7340 <lock_release+0x11b0>
    ...
    3200:	19c50513          	add	a0,a0,412 # 7398 <lock_release+0x1208>
...
0000000000003216 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    324c:	18850513          	add	a0,a0,392 # 73d0 <lock_release+0x1240>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3276:	16e50513          	add	a0,a0,366 # 73e0 <lock_release+0x1250>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    3306:	0ce50513          	add	a0,a0,206 # 73d0 <lock_release+0x1240>
  ...
  unlink("diskfulldir");
    ...
    331a:	0ba50513          	add	a0,a0,186 # 73d0 <lock_release+0x1240>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3448:	fbc50513          	add	a0,a0,-68 # 7400 <lock_release+0x1270>
...
0000000000003456 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3466:	fce50513          	add	a0,a0,-50 # 7430 <lock_release+0x12a0>
  ...
  if(chdir("iputdir") < 0){
    ...
    347a:	fba50513          	add	a0,a0,-70 # 7430 <lock_release+0x12a0>
  ...
  if(unlink("../iputdir") < 0){
    ...
    348e:	fe650513          	add	a0,a0,-26 # 7470 <lock_release+0x12e0>
  ...
  if(chdir("/") < 0){
    ...
    34a2:	00250513          	add	a0,a0,2 # 74a0 <lock_release+0x1310>
    ...
    34c2:	f7a50513          	add	a0,a0,-134 # 7438 <lock_release+0x12a8>
    ...
    34de:	f7650513          	add	a0,a0,-138 # 7450 <lock_release+0x12c0>
    ...
    34fa:	f8a50513          	add	a0,a0,-118 # 7480 <lock_release+0x12f0>
    ...
    3516:	f9650513          	add	a0,a0,-106 # 74a8 <lock_release+0x1318>
...
000000000000352c <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    354a:	eea50513          	add	a0,a0,-278 # 7430 <lock_release+0x12a0>
    ...
    355e:	ed650513          	add	a0,a0,-298 # 7430 <lock_release+0x12a0>
    ...
    3572:	f0250513          	add	a0,a0,-254 # 7470 <lock_release+0x12e0>
    ...
    3592:	4e250513          	add	a0,a0,1250 # 6a70 <lock_release+0x8e0>
    ...
    35ae:	e8e50513          	add	a0,a0,-370 # 7438 <lock_release+0x12a8>
    ...
    35ca:	efa50513          	add	a0,a0,-262 # 74c0 <lock_release+0x1330>
    ...
    35e6:	e9e50513          	add	a0,a0,-354 # 7480 <lock_release+0x12f0>
...
0000000000003614 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3624:	eb850513          	add	a0,a0,-328 # 74d8 <lock_release+0x1348>
  ...
  if(chdir("dir0") < 0){
    ...
    3638:	ea450513          	add	a0,a0,-348 # 74d8 <lock_release+0x1348>
  ...
  if(chdir("..") < 0){
    ...
    364c:	eb050513          	add	a0,a0,-336 # 74f8 <lock_release+0x1368>
  ...
  if(unlink("dir0") < 0){
    ...
    3660:	e7c50513          	add	a0,a0,-388 # 74d8 <lock_release+0x1348>
    ...
    3680:	dbc50513          	add	a0,a0,-580 # 7438 <lock_release+0x12a8>
    ...
    369c:	e4850513          	add	a0,a0,-440 # 74e0 <lock_release+0x1350>
    ...
    36b8:	e4c50513          	add	a0,a0,-436 # 7500 <lock_release+0x1370>
    ...
    36d4:	e4850513          	add	a0,a0,-440 # 7518 <lock_release+0x1388>
...
00000000000036ea <subdir>:
{
  ...
  unlink("ff");
    ...
    36fc:	f6850513          	add	a0,a0,-152 # 7660 <lock_release+0x14d0>
    3700:	00002097          	auipc	ra,0x2
    3704:	54c080e7          	jalr	1356(ra) # 5c4c <unlink>
  if(mkdir("dd") != 0){
    3708:	00004517          	auipc	a0,0x4
    370c:	e2850513          	add	a0,a0,-472 # 7530 <lock_release+0x13a0>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3724:	e3050513          	add	a0,a0,-464 # 7550 <lock_release+0x13c0>
  ...
  write(fd, "ff", 2);
    ...
    373c:	f2858593          	add	a1,a1,-216 # 7660 <lock_release+0x14d0>
  ...
  if(unlink("dd") >= 0){
    ...
    3756:	dde50513          	add	a0,a0,-546 # 7530 <lock_release+0x13a0>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    376a:	e4250513          	add	a0,a0,-446 # 75a8 <lock_release+0x1418>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3782:	e5250513          	add	a0,a0,-430 # 75d0 <lock_release+0x1440>
  ...
  write(fd, "FF", 2);
    ...
    379a:	e6a58593          	add	a1,a1,-406 # 7600 <lock_release+0x1470>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    37b6:	e5650513          	add	a0,a0,-426 # 7608 <lock_release+0x1478>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37fe:	e5e58593          	add	a1,a1,-418 # 7658 <lock_release+0x14c8>
    3802:	00004517          	auipc	a0,0x4
    3806:	dce50513          	add	a0,a0,-562 # 75d0 <lock_release+0x1440>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    381a:	dba50513          	add	a0,a0,-582 # 75d0 <lock_release+0x1440>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3830:	da450513          	add	a0,a0,-604 # 75d0 <lock_release+0x1440>
  ...
  if(chdir("dd") != 0){
    ...
    3844:	cf050513          	add	a0,a0,-784 # 7530 <lock_release+0x13a0>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3858:	e9c50513          	add	a0,a0,-356 # 76f0 <lock_release+0x1560>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    386c:	eb850513          	add	a0,a0,-328 # 7720 <lock_release+0x1590>
  ...
  if(chdir("./..") != 0){
    ...
    3880:	ed450513          	add	a0,a0,-300 # 7750 <lock_release+0x15c0>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3896:	dc650513          	add	a0,a0,-570 # 7658 <lock_release+0x14c8>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    38d0:	d0450513          	add	a0,a0,-764 # 75d0 <lock_release+0x1440>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38e8:	efc50513          	add	a0,a0,-260 # 77e0 <lock_release+0x1650>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3900:	f1450513          	add	a0,a0,-236 # 7810 <lock_release+0x1680>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3918:	c1c50513          	add	a0,a0,-996 # 7530 <lock_release+0x13a0>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    392e:	c0650513          	add	a0,a0,-1018 # 7530 <lock_release+0x13a0>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3944:	bf050513          	add	a0,a0,-1040 # 7530 <lock_release+0x13a0>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3958:	f4c58593          	add	a1,a1,-180 # 78a0 <lock_release+0x1710>
    395c:	00004517          	auipc	a0,0x4
    3960:	e8450513          	add	a0,a0,-380 # 77e0 <lock_release+0x1650>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3974:	f3058593          	add	a1,a1,-208 # 78a0 <lock_release+0x1710>
    3978:	00004517          	auipc	a0,0x4
    397c:	e9850513          	add	a0,a0,-360 # 7810 <lock_release+0x1680>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3990:	ccc58593          	add	a1,a1,-820 # 7658 <lock_release+0x14c8>
    3994:	00004517          	auipc	a0,0x4
    3998:	bbc50513          	add	a0,a0,-1092 # 7550 <lock_release+0x13c0>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    39ac:	e3850513          	add	a0,a0,-456 # 77e0 <lock_release+0x1650>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    39c0:	e5450513          	add	a0,a0,-428 # 7810 <lock_release+0x1680>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39d4:	c8850513          	add	a0,a0,-888 # 7658 <lock_release+0x14c8>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39e8:	e2c50513          	add	a0,a0,-468 # 7810 <lock_release+0x1680>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39fc:	de850513          	add	a0,a0,-536 # 77e0 <lock_release+0x1650>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3a10:	b4450513          	add	a0,a0,-1212 # 7550 <lock_release+0x13c0>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3a24:	fd050513          	add	a0,a0,-48 # 79f0 <lock_release+0x1860>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a38:	c2450513          	add	a0,a0,-988 # 7658 <lock_release+0x14c8>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a4c:	b0850513          	add	a0,a0,-1272 # 7550 <lock_release+0x13c0>
  ...
  if(unlink("dd") == 0){
    ...
    3a60:	ad450513          	add	a0,a0,-1324 # 7530 <lock_release+0x13a0>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a74:	ff050513          	add	a0,a0,-16 # 7a60 <lock_release+0x18d0>
  ...
  if(unlink("dd") < 0){
    ...
    3a88:	aac50513          	add	a0,a0,-1364 # 7530 <lock_release+0x13a0>
    ...
    3aaa:	a9250513          	add	a0,a0,-1390 # 7538 <lock_release+0x13a8>
    ...
    3ac6:	a9650513          	add	a0,a0,-1386 # 7558 <lock_release+0x13c8>
    ...
    3ae2:	a9a50513          	add	a0,a0,-1382 # 7578 <lock_release+0x13e8>
    ...
    3afe:	ab650513          	add	a0,a0,-1354 # 75b0 <lock_release+0x1420>
    ...
    3b1a:	aca50513          	add	a0,a0,-1334 # 75e0 <lock_release+0x1450>
    ...
    3b36:	ae650513          	add	a0,a0,-1306 # 7618 <lock_release+0x1488>
    ...
    3b52:	aea50513          	add	a0,a0,-1302 # 7638 <lock_release+0x14a8>
    ...
    3b6e:	afe50513          	add	a0,a0,-1282 # 7668 <lock_release+0x14d8>
    ...
    3b8a:	b0a50513          	add	a0,a0,-1270 # 7690 <lock_release+0x1500>
    ...
    3ba6:	b0e50513          	add	a0,a0,-1266 # 76b0 <lock_release+0x1520>
    ...
    3bc2:	b1a50513          	add	a0,a0,-1254 # 76d8 <lock_release+0x1548>
    ...
    3bde:	b2650513          	add	a0,a0,-1242 # 7700 <lock_release+0x1570>
    ...
    3bfa:	b3a50513          	add	a0,a0,-1222 # 7730 <lock_release+0x15a0>
    ...
    3c16:	b4650513          	add	a0,a0,-1210 # 7758 <lock_release+0x15c8>
    ...
    3c32:	b4250513          	add	a0,a0,-1214 # 7770 <lock_release+0x15e0>
    ...
    3c4e:	b4650513          	add	a0,a0,-1210 # 7790 <lock_release+0x1600>
    ...
    3c6a:	b4a50513          	add	a0,a0,-1206 # 77b0 <lock_release+0x1620>
    ...
    3c86:	b6e50513          	add	a0,a0,-1170 # 77f0 <lock_release+0x1660>
    ...
    3ca2:	b8250513          	add	a0,a0,-1150 # 7820 <lock_release+0x1690>
    ...
    3cbe:	b8650513          	add	a0,a0,-1146 # 7840 <lock_release+0x16b0>
    ...
    3cda:	b8a50513          	add	a0,a0,-1142 # 7860 <lock_release+0x16d0>
    ...
    3cf6:	b8e50513          	add	a0,a0,-1138 # 7880 <lock_release+0x16f0>
    ...
    3d12:	ba250513          	add	a0,a0,-1118 # 78b0 <lock_release+0x1720>
    ...
    3d2e:	bae50513          	add	a0,a0,-1106 # 78d8 <lock_release+0x1748>
    ...
    3d4a:	bba50513          	add	a0,a0,-1094 # 7900 <lock_release+0x1770>
    ...
    3d66:	bc650513          	add	a0,a0,-1082 # 7928 <lock_release+0x1798>
    ...
    3d82:	bca50513          	add	a0,a0,-1078 # 7948 <lock_release+0x17b8>
    ...
    3d9e:	bce50513          	add	a0,a0,-1074 # 7968 <lock_release+0x17d8>
    ...
    3dba:	bda50513          	add	a0,a0,-1062 # 7990 <lock_release+0x1800>
    ...
    3dd6:	bde50513          	add	a0,a0,-1058 # 79b0 <lock_release+0x1820>
    ...
    3df2:	be250513          	add	a0,a0,-1054 # 79d0 <lock_release+0x1840>
    ...
    3e0e:	bee50513          	add	a0,a0,-1042 # 79f8 <lock_release+0x1868>
    ...
    3e2a:	86a50513          	add	a0,a0,-1942 # 7690 <lock_release+0x1500>
    ...
    3e46:	bd650513          	add	a0,a0,-1066 # 7a18 <lock_release+0x1888>
    ...
    3e62:	bda50513          	add	a0,a0,-1062 # 7a38 <lock_release+0x18a8>
    ...
    3e7e:	bee50513          	add	a0,a0,-1042 # 7a68 <lock_release+0x18d8>
    ...
    3e9a:	bf250513          	add	a0,a0,-1038 # 7a88 <lock_release+0x18f8>
...
0000000000003eb0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3ec0:	be450513          	add	a0,a0,-1052 # 7aa0 <lock_release+0x1910>
  ...
  if(chdir("dots") != 0){
    ...
    3ed2:	bd250513          	add	a0,a0,-1070 # 7aa0 <lock_release+0x1910>
  ...
  if(unlink(".") == 0){
    ...
    3ee4:	9f050513          	add	a0,a0,-1552 # 68d0 <lock_release+0x740>
  ...
  if(unlink("..") == 0){
    ...
    3ef6:	60650513          	add	a0,a0,1542 # 74f8 <lock_release+0x1368>
  ...
  if(chdir("/") != 0){
    ...
    3f08:	59c50513          	add	a0,a0,1436 # 74a0 <lock_release+0x1310>
  ...
  if(unlink("dots/.") == 0){
    ...
    3f1a:	bf250513          	add	a0,a0,-1038 # 7b08 <lock_release+0x1978>
  ...
  if(unlink("dots/..") == 0){
    ...
    3f2c:	c0850513          	add	a0,a0,-1016 # 7b30 <lock_release+0x19a0>
  ...
  if(unlink("dots") != 0){
    ...
    3f3e:	b6650513          	add	a0,a0,-1178 # 7aa0 <lock_release+0x1910>
    ...
    3f5c:	b5050513          	add	a0,a0,-1200 # 7aa8 <lock_release+0x1918>
    ...
    3f78:	b4c50513          	add	a0,a0,-1204 # 7ac0 <lock_release+0x1930>
    ...
    3f94:	b4850513          	add	a0,a0,-1208 # 7ad8 <lock_release+0x1948>
    ...
    3fb0:	b4450513          	add	a0,a0,-1212 # 7af0 <lock_release+0x1960>
    ...
    3fcc:	4e050513          	add	a0,a0,1248 # 74a8 <lock_release+0x1318>
    ...
    3fe8:	b2c50513          	add	a0,a0,-1236 # 7b10 <lock_release+0x1980>
    ...
    4004:	b3850513          	add	a0,a0,-1224 # 7b38 <lock_release+0x19a8>
    ...
    4020:	b3c50513          	add	a0,a0,-1220 # 7b58 <lock_release+0x19c8>
...
0000000000004036 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    404c:	b3050513          	add	a0,a0,-1232 # 7b78 <lock_release+0x19e8>
  ...
  if(chdir("dirfile") == 0){
    ...
    4068:	b1450513          	add	a0,a0,-1260 # 7b78 <lock_release+0x19e8>
  ...
  fd = open("dirfile/xx", 0);
    ...
    407c:	b4850513          	add	a0,a0,-1208 # 7bc0 <lock_release+0x1a30>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4094:	b3050513          	add	a0,a0,-1232 # 7bc0 <lock_release+0x1a30>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    40a8:	b1c50513          	add	a0,a0,-1252 # 7bc0 <lock_release+0x1a30>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    40bc:	b0850513          	add	a0,a0,-1272 # 7bc0 <lock_release+0x1a30>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    40d0:	af458593          	add	a1,a1,-1292 # 7bc0 <lock_release+0x1a30>
    40d4:	00002517          	auipc	a0,0x2
    40d8:	2ec50513          	add	a0,a0,748 # 63c0 <lock_release+0x230>
  ...
  if(unlink("dirfile") != 0){
    ...
    40ec:	a9050513          	add	a0,a0,-1392 # 7b78 <lock_release+0x19e8>
  ...
  fd = open(".", O_RDWR);
    ...
    4102:	7d250513          	add	a0,a0,2002 # 68d0 <lock_release+0x740>
  ...
  fd = open(".", 0);
    ...
    4118:	7bc50513          	add	a0,a0,1980 # 68d0 <lock_release+0x740>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    412c:	13058593          	add	a1,a1,304 # 6258 <lock_release+0xc8>
  ...
  close(fd);
    ...
    4158:	a2c50513          	add	a0,a0,-1492 # 7b80 <lock_release+0x19f0>
    ...
    4174:	a3050513          	add	a0,a0,-1488 # 7ba0 <lock_release+0x1a10>
    ...
    4190:	a4450513          	add	a0,a0,-1468 # 7bd0 <lock_release+0x1a40>
    ...
    41ac:	a2850513          	add	a0,a0,-1496 # 7bd0 <lock_release+0x1a40>
    ...
    41c8:	a3450513          	add	a0,a0,-1484 # 7bf8 <lock_release+0x1a68>
    ...
    41e4:	a4050513          	add	a0,a0,-1472 # 7c20 <lock_release+0x1a90>
    ...
    4200:	a4c50513          	add	a0,a0,-1460 # 7c48 <lock_release+0x1ab8>
    ...
    421c:	a5850513          	add	a0,a0,-1448 # 7c70 <lock_release+0x1ae0>
    ...
    4238:	a5c50513          	add	a0,a0,-1444 # 7c90 <lock_release+0x1b00>
    ...
    4254:	a6850513          	add	a0,a0,-1432 # 7cb8 <lock_release+0x1b28>
...
000000000000426a <iref>:
{
    ...
    4288:	a4ca0a13          	add	s4,s4,-1460 # 7cd0 <lock_release+0x1b40>
    mkdir("");
    428c:	00003497          	auipc	s1,0x3
    4290:	54c48493          	add	s1,s1,1356 # 77d8 <lock_release+0x1648>
    link("README", "");
    4294:	00002a97          	auipc	s5,0x2
    4298:	12ca8a93          	add	s5,s5,300 # 63c0 <lock_release+0x230>
    fd = open("xx", O_CREATE);
    429c:	00004997          	auipc	s3,0x4
    42a0:	92c98993          	add	s3,s3,-1748 # 7bc8 <lock_release+0x1a38>
    42a4:	a891                	j	42f8 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    42a6:	85da                	mv	a1,s6
    42a8:	00004517          	auipc	a0,0x4
    42ac:	a3050513          	add	a0,a0,-1488 # 7cd8 <lock_release+0x1b48>
    ...
    42c8:	a2c50513          	add	a0,a0,-1492 # 7cf0 <lock_release+0x1b60>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    435c:	1a098993          	add	s3,s3,416 # 74f8 <lock_release+0x1368>
    unlink("irefd");
    4360:	00004917          	auipc	s2,0x4
    4364:	97090913          	add	s2,s2,-1680 # 7cd0 <lock_release+0x1b40>
    chdir("..");
    4368:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4384:	12050513          	add	a0,a0,288 # 74a0 <lock_release+0x1310>
...
00000000000043a4 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    43b4:	95850513          	add	a0,a0,-1704 # 7d08 <lock_release+0x1b78>
  ...
  if(pid == 0){
    ...
    43d8:	93450513          	add	a0,a0,-1740 # 7d08 <lock_release+0x1b78>
    ...
    43ee:	93e50513          	add	a0,a0,-1730 # 7d28 <lock_release+0x1b98>
    ...
    440a:	90a50513          	add	a0,a0,-1782 # 7d10 <lock_release+0x1b80>
    ...
    4426:	64e50513          	add	a0,a0,1614 # 6a70 <lock_release+0x8e0>
  ...
  if(unlink("oidir") != 0){
    ...
    4454:	8b850513          	add	a0,a0,-1864 # 7d08 <lock_release+0x1b78>
    ...
    4468:	7fc50513          	add	a0,a0,2044 # 6c60 <lock_release+0xad0>
...
0000000000004496 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    44a6:	8ae50513          	add	a0,a0,-1874 # 7d50 <lock_release+0x1bc0>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    44d2:	88250513          	add	a0,a0,-1918 # 7d50 <lock_release+0x1bc0>
  ...
  sleep(10); // one second
    ...
    450a:	72a50513          	add	a0,a0,1834 # 6c30 <lock_release+0xaa0>
    ...
    4524:	83048493          	add	s1,s1,-2000 # 7d50 <lock_release+0x1bc0>
    4528:	4581                	li	a1,0
    452a:	8526                	mv	a0,s1
    ...
    454c:	80850513          	add	a0,a0,-2040 # 7d50 <lock_release+0x1bc0>
...
000000000000456c <killstatus>:
{
  ...
  exit(0);
    ...
    45d2:	4a250513          	add	a0,a0,1186 # 6a70 <lock_release+0x8e0>
    ...
    45f8:	76c50513          	add	a0,a0,1900 # 7d60 <lock_release+0x1bd0>
...
000000000000460e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4638:	5fc50513          	add	a0,a0,1532 # 6c30 <lock_release+0xaa0>
  ...
  if(pid2 == 0)
    ...
    4666:	40e50513          	add	a0,a0,1038 # 6a70 <lock_release+0x8e0>
  ...
  if(pid3 == 0){
    ...
    46aa:	bb258593          	add	a1,a1,-1102 # 6258 <lock_release+0xc8>
    ...
    46d4:	3a050513          	add	a0,a0,928 # 6a70 <lock_release+0x8e0>
    ...
    46f0:	69450513          	add	a0,a0,1684 # 7d80 <lock_release+0x1bf0>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    472c:	67050513          	add	a0,a0,1648 # 7d98 <lock_release+0x1c08>
  ...
  printf("kill... ");
    ...
    4758:	65c50513          	add	a0,a0,1628 # 7db0 <lock_release+0x1c20>
  ...
  printf("wait... ");
    ...
    4786:	63e50513          	add	a0,a0,1598 # 7dc0 <lock_release+0x1c30>
...
00000000000047b2 <reparent>:
{
  ...
  exit(0);
    ...
    4806:	26e50513          	add	a0,a0,622 # 6a70 <lock_release+0x8e0>
    ...
    4822:	3da50513          	add	a0,a0,986 # 6bf8 <lock_release+0xa68>
...
0000000000004862 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4898:	2e450513          	add	a0,a0,740 # 6b78 <lock_release+0x9e8>
    ...
    48cc:	99058593          	add	a1,a1,-1648 # 6258 <lock_release+0xc8>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4990:	44450513          	add	a0,a0,1092 # 7dd0 <lock_release+0x1c40>
    ...
    49ac:	0c850513          	add	a0,a0,200 # 6a70 <lock_release+0x8e0>
    ...
    49f8:	3fc50513          	add	a0,a0,1020 # 7df0 <lock_release+0x1c60>
...
0000000000004a18 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a9c:	38850513          	add	a0,a0,904 # 7e20 <lock_release+0x1c90>
...
0000000000004abc <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4b5e:	2f650513          	add	a0,a0,758 # 7e50 <lock_release+0x1cc0>
    ...
    4b7a:	30250513          	add	a0,a0,770 # 7e78 <lock_release+0x1ce8>
  ...
  fd = open("sharedfd", 0);
    ...
    4bbe:	28650513          	add	a0,a0,646 # 7e40 <lock_release+0x1cb0>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4bfe:	29e50513          	add	a0,a0,670 # 7e98 <lock_release+0x1d08>
  ...
  unlink("sharedfd");
    ...
    4c3a:	20a50513          	add	a0,a0,522 # 7e40 <lock_release+0x1cb0>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c60:	26450513          	add	a0,a0,612 # 7ec0 <lock_release+0x1d30>
...
0000000000004c80 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4ca4:	23878793          	add	a5,a5,568 # 7ed8 <lock_release+0x1d48>
    4ca8:	f6f43823          	sd	a5,-144(s0)
    4cac:	00003797          	auipc	a5,0x3
    4cb0:	23478793          	add	a5,a5,564 # 7ee0 <lock_release+0x1d50>
    4cb4:	f6f43c23          	sd	a5,-136(s0)
    4cb8:	00003797          	auipc	a5,0x3
    4cbc:	23078793          	add	a5,a5,560 # 7ee8 <lock_release+0x1d58>
    4cc0:	f8f43023          	sd	a5,-128(s0)
    4cc4:	00003797          	auipc	a5,0x3
    4cc8:	22c78793          	add	a5,a5,556 # 7ef0 <lock_release+0x1d60>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d36:	14650513          	add	a0,a0,326 # 6e78 <lock_release+0xce8>
    ...
    4db0:	14c50513          	add	a0,a0,332 # 7ef8 <lock_release+0x1d68>
    ...
    4dca:	14250513          	add	a0,a0,322 # 7f08 <lock_release+0x1d78>
    ...
    4df0:	13450513          	add	a0,a0,308 # 7f20 <lock_release+0x1d90>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e78:	0bc50513          	add	a0,a0,188 # 7f30 <lock_release+0x1da0>
...
0000000000004eac <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eda:	072b8b93          	add	s7,s7,114 # 7f48 <lock_release+0x1db8>
  for(i = 0; i < N; i++){
    ...
    4f1c:	03850513          	add	a0,a0,56 # 7f50 <lock_release+0x1dc0>
    ...
    4f3a:	01250513          	add	a0,a0,18 # 7f48 <lock_release+0x1db8>
  ...
  fd = open(".", 0);
    ...
    4f72:	96250513          	add	a0,a0,-1694 # 68d0 <lock_release+0x740>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4fea:	f8a50513          	add	a0,a0,-118 # 7f70 <lock_release+0x1de0>
    ...
    500a:	f8a50513          	add	a0,a0,-118 # 7f90 <lock_release+0x1e00>
  ...
  for(i = 0; i < N; i++){
    ...
    5042:	f7a50513          	add	a0,a0,-134 # 7fb8 <lock_release+0x1e28>
    ...
    505e:	a1650513          	add	a0,a0,-1514 # 6a70 <lock_release+0x8e0>
...
0000000000005208 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5290:	d6450513          	add	a0,a0,-668 # 7ff0 <lock_release+0x1e60>
  ...
  for(i = 0; ; i++){
    ...
    52f4:	d1050513          	add	a0,a0,-752 # 8000 <lock_release+0x1e70>
    ...
    5310:	d1450513          	add	a0,a0,-748 # 8020 <lock_release+0x1e90>
    ...
    532c:	d1850513          	add	a0,a0,-744 # 8040 <lock_release+0x1eb0>
    ...
    5348:	d1c50513          	add	a0,a0,-740 # 8060 <lock_release+0x1ed0>
    ...
    5364:	d2050513          	add	a0,a0,-736 # 8080 <lock_release+0x1ef0>
    ...
    5380:	d1c50513          	add	a0,a0,-740 # 8098 <lock_release+0x1f08>
  ...
  unlink("bigfile.dat");
    ...
    53ae:	c4650513          	add	a0,a0,-954 # 7ff0 <lock_release+0x1e60>
    ...
    53d2:	cea50513          	add	a0,a0,-790 # 80b8 <lock_release+0x1f28>
...
00000000000053e8 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    5408:	cd450513          	add	a0,a0,-812 # 80d8 <lock_release+0x1f48>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5428:	cc4c8c93          	add	s9,s9,-828 # 80e8 <lock_release+0x1f58>
    name[0] = 'f';
    ...
    5498:	c6450513          	add	a0,a0,-924 # 80f8 <lock_release+0x1f68>
  ...
  printf("fsfull test finished\n");
    ...
    550e:	c0e50513          	add	a0,a0,-1010 # 8118 <lock_release+0x1f88>
    ...
    5564:	ba850513          	add	a0,a0,-1112 # 8108 <lock_release+0x1f78>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5596:	b9e50513          	add	a0,a0,-1122 # 8130 <lock_release+0x1fa0>
  ...
  if(pid == 0) {
    ...
    55c6:	b9650513          	add	a0,a0,-1130 # 8158 <lock_release+0x1fc8>
    ...
    55ea:	b5a50513          	add	a0,a0,-1190 # 8140 <lock_release+0x1fb0>
    ...
    5612:	b5250513          	add	a0,a0,-1198 # 8160 <lock_release+0x1fd0>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5662:	b0a50513          	add	a0,a0,-1270 # 8168 <lock_release+0x1fd8>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56bc:	ba098993          	add	s3,s3,-1120 # 6258 <lock_release+0xc8>
      uint64 a = (uint64) sbrk(4096);
    ...
    56ee:	ad650513          	add	a0,a0,-1322 # 81c0 <lock_release+0x2030>
    ...
    570e:	a7650513          	add	a0,a0,-1418 # 8180 <lock_release+0x1ff0>
    ...
    572e:	a7650513          	add	a0,a0,-1418 # 81a0 <lock_release+0x2010>
  ...
  while(1){
    ...
    5782:	a6250513          	add	a0,a0,-1438 # 81e0 <lock_release+0x2050>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    57e0:	a24b8b93          	add	s7,s7,-1500 # 8200 <lock_release+0x2070>
    int free0 = countfree();
    int free1 = 0;
    ...
    57fa:	a22d0d13          	add	s10,s10,-1502 # 8218 <lock_release+0x2088>
          return 1;
        }
      }
    }
    ...
    5802:	a3ac8c93          	add	s9,s9,-1478 # 8238 <lock_release+0x20a8>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58da:	99258593          	add	a1,a1,-1646 # 8268 <lock_release+0x20d8>
  ...
  char *justone = 0;
    ...
    58f8:	97c58593          	add	a1,a1,-1668 # 8270 <lock_release+0x20e0>
    ...
    590e:	9b658593          	add	a1,a1,-1610 # 82c0 <lock_release+0x2130>
  ...
  int continuous = 0;
    ...
    593a:	94250513          	add	a0,a0,-1726 # 8278 <lock_release+0x20e8>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5960:	94c50513          	add	a0,a0,-1716 # 82a8 <lock_release+0x2118>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5ce8:	9a450513          	add	a0,a0,-1628 # 8688 <digits>
    5cec:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5dea:	00003717          	auipc	a4,0x3
    5dee:	84670713          	add	a4,a4,-1978 # 8630 <lock_release+0x24a0>
  ...
  putc(fd, 'x');
    ...
    5e76:	00003b97          	auipc	s7,0x3
    5e7a:	812b8b93          	add	s7,s7,-2030 # 8688 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5ed0:	73c90913          	add	s2,s2,1852 # 8608 <lock_release+0x2478>
        while(*s != 0){
...
0000000000006124 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
    6124:	1101                	add	sp,sp,-32
    6126:	ec06                	sd	ra,24(sp)
    6128:	e822                	sd	s0,16(sp)
    612a:	e426                	sd	s1,8(sp)
    612c:	e04a                	sd	s2,0(sp)
    612e:	1000                	add	s0,sp,32
    6130:	84aa                	mv	s1,a0
    6132:	892e                	mv	s2,a1
    // Allocate a stack pointer of PGSIZE bytes (4096).
    int ptr_size = PGSIZE * sizeof(void);
    void* st_ptr = (void*)malloc(ptr_size);
    6134:	6505                	lui	a0,0x1
    6136:	00000097          	auipc	ra,0x0
    613a:	eee080e7          	jalr	-274(ra) # 6024 <malloc>
    int tid = clone(st_ptr);
    613e:	00000097          	auipc	ra,0x0
    6142:	b5e080e7          	jalr	-1186(ra) # 5c9c <clone>

    // For the child process, call the start_routine function with the argument.
    if (tid == 0) {
    6146:	c901                	beqz	a0,6156 <thread_create+0x32>
        exit(0);
    }
    ...
    614e:	64a2                	ld	s1,8(sp)
    6150:	6902                	ld	s2,0(sp)
    6152:	6105                	add	sp,sp,32
    6154:	8082                	ret
        (*start_routine)(arg);
    6156:	854a                	mv	a0,s2
    6158:	9482                	jalr	s1
    ...
    6160:	aa0080e7          	jalr	-1376(ra) # 5bfc <exit>

0000000000006164 <lock_init>:

// Initialize a lock.
void lock_init(struct lock_t* lock) {
    6164:	1141                	add	sp,sp,-16
    6166:	e422                	sd	s0,8(sp)
    6168:	0800                	add	s0,sp,16
    lock->locked = 0;
    616a:	00052023          	sw	zero,0(a0) # 1000 <linktest+0x10c>
}
    616e:	6422                	ld	s0,8(sp)
    6170:	0141                	add	sp,sp,16
    6172:	8082                	ret

0000000000006174 <lock_acquire>:

// Acquire the lock.
void lock_acquire(struct lock_t* lock) {
    6174:	1141                	add	sp,sp,-16
    6176:	e422                	sd	s0,8(sp)
    6178:	0800                	add	s0,sp,16
    // Spin until the lock is acquired.
    while (__sync_lock_test_and_set(&lock->locked, 1) != 0);
    617a:	4705                	li	a4,1
    617c:	87ba                	mv	a5,a4
    617e:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    6182:	2781                	sext.w	a5,a5
    6184:	ffe5                	bnez	a5,617c <lock_acquire+0x8>
    // Ensure memory operations strictly follow the lock acquisition.
    __sync_synchronize();
    6186:	0ff0000f          	fence
}
    618a:	6422                	ld	s0,8(sp)
    618c:	0141                	add	sp,sp,16
    618e:	8082                	ret

0000000000006190 <lock_release>:

// Release the lock.
void lock_release(struct lock_t* lock) {
    6190:	1141                	add	sp,sp,-16
    6192:	e422                	sd	s0,8(sp)
    6194:	0800                	add	s0,sp,16
    ...
    619a:	0f50000f          	fence	iorw,ow
    619e:	0805202f          	amoswap.w	zero,zero,(a0)
}
    61a2:	6422                	ld	s0,8(sp)
    61a4:	0141                	add	sp,sp,16
    61a6:	8082                	ret
