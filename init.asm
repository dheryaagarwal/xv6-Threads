...
main(void)
{
  ...
  12:	92250513          	add	a0,a0,-1758 # 930 <lock_release+0x1e>
  ...
  3a:	90290913          	add	s2,s2,-1790 # 938 <lock_release+0x26>
  3e:	854a                	mv	a0,s2
  ...
  6e:	91e50513          	add	a0,a0,-1762 # 988 <lock_release+0x76>
  ...
  8c:	8a850513          	add	a0,a0,-1880 # 930 <lock_release+0x1e>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	89650513          	add	a0,a0,-1898 # 930 <lock_release+0x1e>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	8a450513          	add	a0,a0,-1884 # 950 <lock_release+0x3e>
  ...
  d2:	89a50513          	add	a0,a0,-1894 # 968 <lock_release+0x56>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	89250513          	add	a0,a0,-1902 # 970 <lock_release+0x5e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46a:	5a250513          	add	a0,a0,1442 # a08 <digits>
 46e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 570:	44470713          	add	a4,a4,1092 # 9b0 <lock_release+0x9e>
 ...
 5fc:	410b8b93          	add	s7,s7,1040 # a08 <digits>
 ...
 652:	35a90913          	add	s2,s2,858 # 9a8 <lock_release+0x96>
        while(*s != 0){
...
00000000000008a6 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 8bc:	eee080e7          	jalr	-274(ra) # 7a6 <malloc>
    int tid = clone(st_ptr);
 8c0:	00000097          	auipc	ra,0x0
 8c4:	b5e080e7          	jalr	-1186(ra) # 41e <clone>

    // For the child process, call the start_routine function with the argument.
    if (tid == 0) {
 8c8:	c901                	beqz	a0,8d8 <thread_create+0x32>
        exit(0);
    }
 ...
 8e2:	aa0080e7          	jalr	-1376(ra) # 37e <exit>

00000000000008e6 <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 8ea:	0800                	add	s0,sp,16
    lock->locked = 0;
 8ec:	00052023          	sw	zero,0(a0) # 1000 <argv>
}
 8f0:	6422                	ld	s0,8(sp)
 8f2:	0141                	add	sp,sp,16
 8f4:	8082                	ret

00000000000008f6 <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 8fc:	4705                	li	a4,1
 8fe:	87ba                	mv	a5,a4
 900:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 904:	2781                	sext.w	a5,a5
 906:	ffe5                	bnez	a5,8fe <lock_acquire+0x8>
...
void lock_release(struct lock_t* lock) {
 ...
 91c:	0f50000f          	fence	iorw,ow
 920:	0805202f          	amoswap.w	zero,zero,(a0)
}
 924:	6422                	ld	s0,8(sp)
