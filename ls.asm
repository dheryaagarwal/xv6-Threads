...
ls(char *path)
{
 ...
 11c:	a2850513          	add	a0,a0,-1496 # b40 <lock_release+0x4a>
 ...
 14e:	9c658593          	add	a1,a1,-1594 # b10 <lock_release+0x1a>
 152:	4509                	li	a0,2
 ...
 164:	9c858593          	add	a1,a1,-1592 # b28 <lock_release+0x32>
 168:	4509                	li	a0,2
 ...
 19a:	9ba50513          	add	a0,a0,-1606 # b50 <lock_release+0x5a>
 ...
 1ea:	982a0a13          	add	s4,s4,-1662 # b68 <lock_release+0x72>
        printf("ls: cannot stat %s\n", buf);
 1ee:	00001a97          	auipc	s5,0x1
 1f2:	93aa8a93          	add	s5,s5,-1734 # b28 <lock_release+0x32>
...
main(int argc, char *argv[])
{
 ...
 2c6:	8b650513          	add	a0,a0,-1866 # b78 <lock_release+0x82>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 64e:	59650513          	add	a0,a0,1430 # be0 <digits>
 652:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 754:	43870713          	add	a4,a4,1080 # b88 <lock_release+0x92>
 ...
 7e0:	404b8b93          	add	s7,s7,1028 # be0 <digits>
 ...
 836:	34e90913          	add	s2,s2,846 # b80 <lock_release+0x8a>
        while(*s != 0){
...
int thread_create(void *(start_routine)(void*), void *arg) {
 a8a:	1101                	add	sp,sp,-32
 a8c:	ec06                	sd	ra,24(sp)
 a8e:	e822                	sd	s0,16(sp)
 a90:	e426                	sd	s1,8(sp)
 a92:	e04a                	sd	s2,0(sp)
 a94:	1000                	add	s0,sp,32
 a96:	84aa                	mv	s1,a0
 a98:	892e                	mv	s2,a1
 ...
 aa0:	eee080e7          	jalr	-274(ra) # 98a <malloc>
    int tid = clone(st_ptr);
 aa4:	00000097          	auipc	ra,0x0
 aa8:	b5e080e7          	jalr	-1186(ra) # 602 <clone>
 ...
 ac6:	aa0080e7          	jalr	-1376(ra) # 562 <exit>
...
void lock_acquire(struct lock_t* lock) {
 ada:	1141                	add	sp,sp,-16
 adc:	e422                	sd	s0,8(sp)
 ade:	0800                	add	s0,sp,16
...
void lock_release(struct lock_t* lock) {
 af6:	1141                	add	sp,sp,-16
 af8:	e422                	sd	s0,8(sp)
 afa:	0800                	add	s0,sp,16
