...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39c:	52850513          	add	a0,a0,1320 # 8c0 <digits>
 3a0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a2:	3ca70713          	add	a4,a4,970 # 868 <lock_release+0x24>
 ...
 52e:	396b8b93          	add	s7,s7,918 # 8c0 <digits>
 ...
 584:	2e090913          	add	s2,s2,736 # 860 <lock_release+0x1c>
        while(*s != 0){
...
00000000000007d8 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 7ee:	eee080e7          	jalr	-274(ra) # 6d8 <malloc>
    int tid = clone(st_ptr);
 7f2:	00000097          	auipc	ra,0x0
 7f6:	b5e080e7          	jalr	-1186(ra) # 350 <clone>

    // For the child process, call the start_routine function with the argument.
    if (tid == 0) {
 7fa:	c901                	beqz	a0,80a <thread_create+0x32>
        exit(0);
    }
 ...
 814:	aa0080e7          	jalr	-1376(ra) # 2b0 <exit>

0000000000000818 <lock_init>:
...
void lock_init(struct lock_t* lock) {
 ...
 81c:	0800                	add	s0,sp,16
    lock->locked = 0;
 81e:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 822:	6422                	ld	s0,8(sp)
 824:	0141                	add	sp,sp,16
 826:	8082                	ret

0000000000000828 <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 82e:	4705                	li	a4,1
 830:	87ba                	mv	a5,a4
 832:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 836:	2781                	sext.w	a5,a5
 838:	ffe5                	bnez	a5,830 <lock_acquire+0x8>
    // Ensure memory operations strictly follow the lock acquisition.
    __sync_synchronize();
 83a:	0ff0000f          	fence
}
 83e:	6422                	ld	s0,8(sp)
 840:	0141                	add	sp,sp,16
 842:	8082                	ret

0000000000000844 <lock_release>:
...
void lock_release(struct lock_t* lock) {
 ...
 84e:	0f50000f          	fence	iorw,ow
 852:	0805202f          	amoswap.w	zero,zero,(a0)
}
 856:	6422                	ld	s0,8(sp)
