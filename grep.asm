...
00000000000001ec <main>:
{
 ...
 25e:	88658593          	add	a1,a1,-1914 # ae0 <lock_release+0x1c>
 262:	4509                	li	a0,2
 ...
 294:	87050513          	add	a0,a0,-1936 # b00 <lock_release+0x3c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 61c:	56050513          	add	a0,a0,1376 # b78 <digits>
 620:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 722:	40270713          	add	a4,a4,1026 # b20 <lock_release+0x5c>
 ...
 7ae:	3ceb8b93          	add	s7,s7,974 # b78 <digits>
 ...
 804:	31890913          	add	s2,s2,792 # b18 <lock_release+0x54>
        while(*s != 0){
...
0000000000000a58 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 a58:	1101                	add	sp,sp,-32
 a5a:	ec06                	sd	ra,24(sp)
 a5c:	e822                	sd	s0,16(sp)
 a5e:	e426                	sd	s1,8(sp)
 a60:	e04a                	sd	s2,0(sp)
 a62:	1000                	add	s0,sp,32
 a64:	84aa                	mv	s1,a0
 a66:	892e                	mv	s2,a1
 ...
 a6e:	eee080e7          	jalr	-274(ra) # 958 <malloc>
    int tid = clone(st_ptr);
 a72:	00000097          	auipc	ra,0x0
 a76:	b5e080e7          	jalr	-1186(ra) # 5d0 <clone>

    // For the child process, call the start_routine function with the argument.
    if (tid == 0) {
 a7a:	c901                	beqz	a0,a8a <thread_create+0x32>
        exit(0);
    }
 ...
 a94:	aa0080e7          	jalr	-1376(ra) # 530 <exit>

0000000000000a98 <lock_init>:

// Initialize a lock.
void lock_init(struct lock_t* lock) {
 a98:	1141                	add	sp,sp,-16
 a9a:	e422                	sd	s0,8(sp)
 a9c:	0800                	add	s0,sp,16
    lock->locked = 0;
 a9e:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 aa2:	6422                	ld	s0,8(sp)
 aa4:	0141                	add	sp,sp,16
 aa6:	8082                	ret

0000000000000aa8 <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 aae:	4705                	li	a4,1
 ab0:	87ba                	mv	a5,a4
 ab2:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 ab6:	2781                	sext.w	a5,a5
 ab8:	ffe5                	bnez	a5,ab0 <lock_acquire+0x8>
...
0000000000000ac4 <lock_release>:

// Release the lock.
void lock_release(struct lock_t* lock) {
 ac4:	1141                	add	sp,sp,-16
 ac6:	e422                	sd	s0,8(sp)
 ...
 ace:	0f50000f          	fence	iorw,ow
 ad2:	0805202f          	amoswap.w	zero,zero,(a0)
}
 ad6:	6422                	ld	s0,8(sp)
