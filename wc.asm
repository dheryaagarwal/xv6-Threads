...
wc(int fd, char *name)
{
  ...
  3c:	998a0a13          	add	s4,s4,-1640 # 9d0 <lock_release+0x26>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  aa:	94a50513          	add	a0,a0,-1718 # 9f0 <lock_release+0x46>
  ...
  d8:	90c50513          	add	a0,a0,-1780 # 9e0 <lock_release+0x36>
...
main(int argc, char *argv[])
{
 ...
 15a:	88258593          	add	a1,a1,-1918 # 9d8 <lock_release+0x2e>
 15e:	4501                	li	a0,0
 ...
 17a:	88a50513          	add	a0,a0,-1910 # a00 <lock_release+0x56>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 502:	57a50513          	add	a0,a0,1402 # a78 <digits>
 506:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 608:	41c70713          	add	a4,a4,1052 # a20 <lock_release+0x76>
 ...
 694:	3e8b8b93          	add	s7,s7,1000 # a78 <digits>
 ...
 6ea:	33290913          	add	s2,s2,818 # a18 <lock_release+0x6e>
        while(*s != 0){
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 954:	eee080e7          	jalr	-274(ra) # 83e <malloc>
    int tid = clone(st_ptr);
 958:	00000097          	auipc	ra,0x0
 95c:	b5e080e7          	jalr	-1186(ra) # 4b6 <clone>

    // For the child process, call the start_routine function with the argument.
    if (tid == 0) {
 960:	c901                	beqz	a0,970 <thread_create+0x32>
        exit(0);
    }
 ...
 97a:	aa0080e7          	jalr	-1376(ra) # 416 <exit>

000000000000097e <lock_init>:

// Initialize a lock.
void lock_init(struct lock_t* lock) {
 97e:	1141                	add	sp,sp,-16
 980:	e422                	sd	s0,8(sp)
 982:	0800                	add	s0,sp,16
    lock->locked = 0;
 984:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 988:	6422                	ld	s0,8(sp)
 98a:	0141                	add	sp,sp,16
 98c:	8082                	ret
...
void lock_acquire(struct lock_t* lock) {
 98e:	1141                	add	sp,sp,-16
 990:	e422                	sd	s0,8(sp)
 992:	0800                	add	s0,sp,16
