...
main(int argc, char *argv[])
{
  ...
  44:	87058593          	add	a1,a1,-1936 # 8b0 <lock_release+0x1c>
  48:	4509                	li	a0,2
  ...
  62:	86a58593          	add	a1,a1,-1942 # 8c8 <lock_release+0x34>
  66:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ec:	56050513          	add	a0,a0,1376 # 948 <digits>
 3f0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f2:	40270713          	add	a4,a4,1026 # 8f0 <lock_release+0x5c>
 ...
 57e:	3ceb8b93          	add	s7,s7,974 # 948 <digits>
 ...
 5d4:	31890913          	add	s2,s2,792 # 8e8 <lock_release+0x54>
        while(*s != 0){
...
0000000000000828 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
 ...
 83e:	eee080e7          	jalr	-274(ra) # 728 <malloc>
    int tid = clone(st_ptr);
 842:	00000097          	auipc	ra,0x0
 846:	b5e080e7          	jalr	-1186(ra) # 3a0 <clone>

    // For the child process, call the start_routine function with the argument.
    if (tid == 0) {
 84a:	c901                	beqz	a0,85a <thread_create+0x32>
        exit(0);
    }
 ...
 864:	aa0080e7          	jalr	-1376(ra) # 300 <exit>

0000000000000868 <lock_init>:

// Initialize a lock.
void lock_init(struct lock_t* lock) {
 868:	1141                	add	sp,sp,-16
 86a:	e422                	sd	s0,8(sp)
 86c:	0800                	add	s0,sp,16
    lock->locked = 0;
 86e:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 872:	6422                	ld	s0,8(sp)
 874:	0141                	add	sp,sp,16
 876:	8082                	ret

0000000000000878 <lock_acquire>:
...
void lock_acquire(struct lock_t* lock) {
 ...
 87e:	4705                	li	a4,1
 880:	87ba                	mv	a5,a4
 882:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 886:	2781                	sext.w	a5,a5
 888:	ffe5                	bnez	a5,880 <lock_acquire+0x8>
...
void lock_release(struct lock_t* lock) {
 ...
 89e:	0f50000f          	fence	iorw,ow
 8a2:	0805202f          	amoswap.w	zero,zero,(a0)
}
 8a6:	6422                	ld	s0,8(sp)
 8a8:	0141                	add	sp,sp,16
 8aa:	8082                	ret
