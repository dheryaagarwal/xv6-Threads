...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	38e58593          	add	a1,a1,910 # 13a0 <lock_release+0x1c>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	35058593          	add	a1,a1,848 # 13b0 <lock_release+0x2c>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	31e50513          	add	a0,a0,798 # 13b8 <lock_release+0x34>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	3f270713          	add	a4,a4,1010 # 14b8 <lock_release+0x134>
    ...
    panic("runcmd");
      ...
      e6:	2de50513          	add	a0,a0,734 # 13c0 <lock_release+0x3c>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     108:	2c458593          	add	a1,a1,708 # 13c8 <lock_release+0x44>
     10c:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     154:	28858593          	add	a1,a1,648 # 13d8 <lock_release+0x54>
     158:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1ea:	20250513          	add	a0,a0,514 # 13e8 <lock_release+0x64>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	e5ca8a93          	add	s5,s5,-420 # 1410 <lock_release+0x8c>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ca:	e2a50513          	add	a0,a0,-470 # 13f0 <lock_release+0x6c>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	d7a60613          	add	a2,a2,-646 # 1418 <lock_release+0x94>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6de:	d5eb0b13          	add	s6,s6,-674 # 1438 <lock_release+0xb4>
  ...
  return ret;
     ...
     70c:	d1850513          	add	a0,a0,-744 # 1420 <lock_release+0x9c>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	cbe50513          	add	a0,a0,-834 # 1428 <lock_release+0xa4>
...
0000000000000794 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b4:	c9060613          	add	a2,a2,-880 # 1440 <lock_release+0xbc>
     7b8:	85ce                	mv	a1,s3
     7ba:	854a                	mv	a0,s2
...
0000000000000802 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     824:	c28a0a13          	add	s4,s4,-984 # 1448 <lock_release+0xc4>
  ...
  if(peek(ps, es, ";")){
     ...
     85a:	bfa60613          	add	a2,a2,-1030 # 1450 <lock_release+0xcc>
     85e:	85ce                	mv	a1,s3
     860:	854a                	mv	a0,s2
...
00000000000008aa <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c0:	b5c60613          	add	a2,a2,-1188 # 1418 <lock_release+0x94>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f0:	b7c60613          	add	a2,a2,-1156 # 1468 <lock_release+0xe4>
     8f4:	85ca                	mv	a1,s2
     8f6:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     932:	b2a50513          	add	a0,a0,-1238 # 1458 <lock_release+0xd4>
     936:	fffff097          	auipc	ra,0xfffff
     93a:	720080e7          	jalr	1824(ra) # 56 <panic>
    panic("syntax - missing )");
     93e:	00001517          	auipc	a0,0x1
     942:	b3250513          	add	a0,a0,-1230 # 1470 <lock_release+0xec>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96e:	b6670713          	add	a4,a4,-1178 # 14d0 <lock_release+0x14c>
...
00000000000009e6 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a1a:	99260613          	add	a2,a2,-1646 # 13a8 <lock_release+0x24>
     a1e:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a50:	a3c58593          	add	a1,a1,-1476 # 1488 <lock_release+0x104>
     a54:	4509                	li	a0,2
     a56:	00000097          	auipc	ra,0x0
     a5a:	6dc080e7          	jalr	1756(ra) # 1132 <fprintf>
    panic("syntax");
     a5e:	00001517          	auipc	a0,0x1
     a62:	9c250513          	add	a0,a0,-1598 # 1420 <lock_release+0x9c>
...
0000000000000a6e <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a82:	a1a48493          	add	s1,s1,-1510 # 1498 <lock_release+0x114>
     a86:	4589                	li	a1,2
     a88:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b38:	96c58593          	add	a1,a1,-1684 # 14a0 <lock_release+0x11c>
     b3c:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     edc:	66850513          	add	a0,a0,1640 # 1540 <digits>
     ee0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fe2:	50a70713          	add	a4,a4,1290 # 14e8 <lock_release+0x164>
  ...
  putc(fd, 'x');
    ...
    106e:	4d6b8b93          	add	s7,s7,1238 # 1540 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10c4:	3f090913          	add	s2,s2,1008 # 14b0 <lock_release+0x12c>
        while(*s != 0){
...
0000000000001318 <thread_create>:
...
int thread_create(void *(start_routine)(void*), void *arg) {
    ...
    1340:	6442                	ld	s0,16(sp)
    1342:	64a2                	ld	s1,8(sp)
    1344:	6902                	ld	s2,0(sp)
    ...
    1354:	aa0080e7          	jalr	-1376(ra) # df0 <exit>

0000000000001358 <lock_init>:

// Initialize a lock.
void lock_init(struct lock_t* lock) {
    1358:	1141                	add	sp,sp,-16
    135a:	e422                	sd	s0,8(sp)
    135c:	0800                	add	s0,sp,16
    lock->locked = 0;
    135e:	00052023          	sw	zero,0(a0) # 1000 <vprintf+0x9a>
}
    1362:	6422                	ld	s0,8(sp)
    1364:	0141                	add	sp,sp,16
    1366:	8082                	ret

0000000000001368 <lock_acquire>:

// Acquire the lock.
void lock_acquire(struct lock_t* lock) {
    1368:	1141                	add	sp,sp,-16
    136a:	e422                	sd	s0,8(sp)
    136c:	0800                	add	s0,sp,16
    // Spin until the lock is acquired.
    while (__sync_lock_test_and_set(&lock->locked, 1) != 0);
    136e:	4705                	li	a4,1
    1370:	87ba                	mv	a5,a4
    1372:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    1376:	2781                	sext.w	a5,a5
    1378:	ffe5                	bnez	a5,1370 <lock_acquire+0x8>
...
0000000000001384 <lock_release>:

// Release the lock.
void lock_release(struct lock_t* lock) {
    1384:	1141                	add	sp,sp,-16
    1386:	e422                	sd	s0,8(sp)
    1388:	0800                	add	s0,sp,16
    ...
    138e:	0f50000f          	fence	iorw,ow
    1392:	0805202f          	amoswap.w	zero,zero,(a0)
}
    1396:	6422                	ld	s0,8(sp)
    1398:	0141                	add	sp,sp,16
    139a:	8082                	ret
